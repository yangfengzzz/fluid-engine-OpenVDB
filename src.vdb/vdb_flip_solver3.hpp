...
#ifndef INCLUDE_VDB_FLIP_SOLVER3_H_
#define INCLUDE_VDB_FLIP_SOLVER3_H_
...
public:
    ...
    FlipSolver3(const vox::Size3& resolution,
...
private:
    ...
    openvdb::DoubleGrid::Ptr _uDelta;
    openvdb::DoubleGrid::Ptr _vDelta;
    openvdb::DoubleGrid::Ptr _wDelta;
};
...
#endif  // INCLUDE_VDB_FLIP_SOLVER3_H_
