...
#ifndef INCLUDE_VDB_ANISOTROPIC_POINTS_TO_IMPLICIT3_H_
#define INCLUDE_VDB_ANISOTROPIC_POINTS_TO_IMPLICIT3_H_
...
#endif  // INCLUDE_VDB_ANISOTROPIC_POINTS_TO_IMPLICIT3_H_
