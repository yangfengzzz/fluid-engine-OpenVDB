...
CellCenteredScalarGrid3::CellCenteredScalarGrid3() : ScalarGrid3(){}
...
vox::Size3 CellCenteredScalarGrid3::dataSize() const {
    // The size of the data should be the same as the grid resolution.
    return resolution();
}

vox::Vector3D CellCenteredScalarGrid3::dataOrigin() const {
...
CellCenteredScalarGrid3::Builder::withResolution(const vox::Size3& resolution) {
...
CellCenteredScalarGrid3::Builder&
CellCenteredScalarGrid3::Builder::withGridSpacing(const vox::Vector3D& gridSpacing) {
...
CellCenteredScalarGrid3::Builder&
CellCenteredScalarGrid3::Builder::withOrigin(const vox::Vector3D& gridOrigin) {
