...
#ifndef INCLUDE_VDB_PARTICLE_SYSTEM_SOLVER3_H_
#define INCLUDE_VDB_PARTICLE_SYSTEM_SOLVER3_H_
...
//! \see        SphSolver3
//!
class ParticleSystemSolver3 : public vox::PhysicsAnimation {
public:
    class Builder;
    ...
    const vox::VectorField3Ptr& wind() const;
    ...
    //!
    void setWind(const vox::VectorField3Ptr& newWind);
...
private:
    ...
    vox::Vector3D _gravity = vox::Vector3D(0.0, vox::kGravity, 0.0);
...
#endif  // INCLUDE_VDB_PARTICLE_SYSTEM_SOLVER3_H_
