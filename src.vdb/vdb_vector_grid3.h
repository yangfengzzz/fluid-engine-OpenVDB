...
#ifndef INCLUDE_VDB_VECTOR_GRID3_H_
#define INCLUDE_VDB_VECTOR_GRID3_H_
...
class VectorGrid3 : public vox::VectorField3, public Grid3 {
public:
    ...
    virtual void fill(const vox::Vector3D& value,
                      vox::ExecutionPolicy policy = vox::ExecutionPolicy::kParallel) = 0;
    
    //! Fills the grid with given position-to-value mapping function.
    virtual void fill(const std::function<vox::Vector3D(const vox::Vector3D&)>& func,
                      vox::ExecutionPolicy policy = vox::ExecutionPolicy::kParallel) = 0;
...
protected:
    ...
    virtual void onResize(
                          ...
                          const vox::Vector3D& origin,
                          const vox::Vector3D& initialValue) = 0;
};
...
public:
    ...
    virtual VectorGrid3Ptr build(
                                 ...
                                 const vox::Vector3D& initialVal) const = 0;
};
...
#endif  // INCLUDE_VDB_VECTOR_GRID3_H_
