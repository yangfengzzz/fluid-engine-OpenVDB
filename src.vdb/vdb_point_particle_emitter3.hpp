...
#ifndef INCLUDE_VDB_POINT_PARTICLE_EMITTER3_H_
#define INCLUDE_VDB_POINT_PARTICLE_EMITTER3_H_
...
public:
    ...
    Builder& withOrigin(const vox::Vector3D& origin);
    
    //! Returns builder with direction.
    Builder& withDirection(const vox::Vector3D& direction);
...
private:
    ...
    vox::Vector3D _origin{0, 0, 0};
    vox::Vector3D _direction{0, 1, 0};
    double _speed = 1.0;
...
#endif  // INCLUDE_VDB_POINT_PARTICLE_EMITTER3_H_
