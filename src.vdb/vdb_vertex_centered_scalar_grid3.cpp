...
VertexCenteredScalarGrid3::VertexCenteredScalarGrid3() : ScalarGrid3() {}
...
vox::Size3 VertexCenteredScalarGrid3::dataSize() const {
...
vox::Vector3D VertexCenteredScalarGrid3::dataOrigin() const {
    return origin();
}
...
VertexCenteredScalarGrid3::Builder::withResolution(const vox::Size3& resolution) {
...
VertexCenteredScalarGrid3::Builder&
VertexCenteredScalarGrid3::Builder::withOrigin(const vox::Vector3D& gridOrigin) {
...
ScalarGrid3Ptr VertexCenteredScalarGrid3::Builder::build(const vox::Size3& resolution,
                                                         const vox::Vector3D& gridSpacing,
