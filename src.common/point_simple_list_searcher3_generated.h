...
inline flatbuffers::Offset<PointSimpleListSearcher3> CreatePointSimpleListSearcher3Direct(
    ...
    return vox::fbs::CreatePointSimpleListSearcher3(
                                                    _fbb,
                                                    points ? _fbb.CreateVector<const vox::fbs::Vector3D *>(*points) : 0);
}

inline const vox::fbs::PointSimpleListSearcher3 *GetPointSimpleListSearcher3(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::PointSimpleListSearcher3>(buf);
}

inline bool VerifyPointSimpleListSearcher3Buffer(
                                                 flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<vox::fbs::PointSimpleListSearcher3>(nullptr);
}

inline void FinishPointSimpleListSearcher3Buffer(
                                                 flatbuffers::FlatBufferBuilder &fbb,
                                                 flatbuffers::Offset<vox::fbs::PointSimpleListSearcher3> root) {
    fbb.Finish(root);
}
