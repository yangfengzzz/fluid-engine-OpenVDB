...
inline flatbuffers::Offset<ScalarGridSerialized2> CreateScalarGridSerialized2Direct(
    ...
    return vox::fbs::CreateScalarGridSerialized2(
                                                 _fbb,
...
inline flatbuffers::Offset<VectorGridSerialized2> CreateVectorGridSerialized2Direct(
                                                                                    ...
                                                                                    const char *type = nullptr,
                                                                                    const std::vector<uint8_t> *data = nullptr) {
    return vox::fbs::CreateVectorGridSerialized2(
                                                 _fbb,
                                                 type ? _fbb.CreateString(type) : 0,
                                                 data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
struct GridSystemData2 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
    ...
    const vox::fbs::Size2 *resolution() const {
        return GetStruct<const vox::fbs::Size2 *>(VT_RESOLUTION);
    }
    const vox::fbs::Vector2D *gridSpacing() const {
        return GetStruct<const vox::fbs::Vector2D *>(VT_GRIDSPACING);
    }
    const vox::fbs::Vector2D *origin() const {
        return GetStruct<const vox::fbs::Vector2D *>(VT_ORIGIN);
    }
    ...
    bool Verify(flatbuffers::Verifier &verifier) const {
        return VerifyTableStart(verifier) &&
        VerifyField<vox::fbs::Size2>(verifier, VT_RESOLUTION) &&
        VerifyField<vox::fbs::Vector2D>(verifier, VT_GRIDSPACING) &&
        VerifyField<vox::fbs::Vector2D>(verifier, VT_ORIGIN) &&
...
struct GridSystemData2Builder {
    flatbuffers::FlatBufferBuilder &fbb_;
    flatbuffers::uoffset_t start_;
    void add_resolution(const vox::fbs::Size2 *resolution) {
    ...
    void add_origin(const vox::fbs::Vector2D *origin) {
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2(
                                                                  flatbuffers::FlatBufferBuilder &_fbb,
                                                                  const vox::fbs::Size2 *resolution = 0,
...
inline flatbuffers::Offset<GridSystemData2> CreateGridSystemData2Direct(
    ...
    return vox::fbs::CreateGridSystemData2(
                                           _fbb,
                                           resolution,
                                           gridSpacing,
                                           origin,
...
inline const vox::fbs::GridSystemData2 *GetGridSystemData2(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::GridSystemData2>(buf);
}

inline bool VerifyGridSystemData2Buffer(
                                        flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<vox::fbs::GridSystemData2>(nullptr);
}

inline void FinishGridSystemData2Buffer(
                                        flatbuffers::FlatBufferBuilder &fbb,
                                        flatbuffers::Offset<vox::fbs::GridSystemData2> root) {
    fbb.Finish(root);
}
