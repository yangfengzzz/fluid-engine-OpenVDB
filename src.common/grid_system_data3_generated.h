...
inline flatbuffers::Offset<ScalarGridSerialized3> CreateScalarGridSerialized3Direct(
    ...
    return vox::fbs::CreateScalarGridSerialized3(
                                                 _fbb,
...
inline flatbuffers::Offset<VectorGridSerialized3> CreateVectorGridSerialized3Direct(
                                                                                    ...
                                                                                    const char *type = nullptr,
                                                                                    const std::vector<uint8_t> *data = nullptr) {
    return vox::fbs::CreateVectorGridSerialized3(
                                                 _fbb,
                                                 type ? _fbb.CreateString(type) : 0,
                                                 data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}
...
inline flatbuffers::Offset<GridSystemData3> CreateGridSystemData3Direct(
    ...
    return vox::fbs::CreateGridSystemData3(
                                           _fbb,
                                           resolution,
                                           gridSpacing,
                                           origin,
...
inline const vox::fbs::GridSystemData3 *GetGridSystemData3(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::GridSystemData3>(buf);
}

inline bool VerifyGridSystemData3Buffer(
                                        flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<vox::fbs::GridSystemData3>(nullptr);
}

inline void FinishGridSystemData3Buffer(
                                        flatbuffers::FlatBufferBuilder &fbb,
                                        flatbuffers::Offset<vox::fbs::GridSystemData3> root) {
    fbb.Finish(root);
}
