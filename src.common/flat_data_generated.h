...
inline flatbuffers::Offset<FlatData> CreateFlatDataDirect(
    ...
    return vox::fbs::CreateFlatData(
                                    _fbb,
                                    data ? _fbb.CreateVector<uint8_t>(*data) : 0);
}

inline const vox::fbs::FlatData *GetFlatData(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::FlatData>(buf);
}
...
inline void FinishFlatDataBuffer(
                                 ...
                                 flatbuffers::Offset<vox::fbs::FlatData> root) {
    fbb.Finish(root);
}
