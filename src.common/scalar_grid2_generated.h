...
inline flatbuffers::Offset<ScalarGrid2> CreateScalarGrid2Direct(
    ...
    return vox::fbs::CreateScalarGrid2(
                                       _fbb,
                                       resolution,
                                       gridSpacing,
                                       origin,
...
inline const vox::fbs::ScalarGrid2 *GetScalarGrid2(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::ScalarGrid2>(buf);
}

inline bool VerifyScalarGrid2Buffer(
                                    flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<vox::fbs::ScalarGrid2>(nullptr);
}

inline void FinishScalarGrid2Buffer(
                                    flatbuffers::FlatBufferBuilder &fbb,
                                    flatbuffers::Offset<vox::fbs::ScalarGrid2> root) {
    fbb.Finish(root);
}
