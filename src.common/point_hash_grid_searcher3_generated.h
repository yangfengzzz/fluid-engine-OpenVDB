...
inline flatbuffers::Offset<PointHashGridSearcherBucket3> CreatePointHashGridSearcherBucket3Direct(
    ...
    return vox::fbs::CreatePointHashGridSearcherBucket3(
                                                        _fbb,
...
inline flatbuffers::Offset<PointHashGridSearcher3> CreatePointHashGridSearcher3Direct(
    ...
    return vox::fbs::CreatePointHashGridSearcher3(
                                                  _fbb,
                                                  gridSpacing,
                                                  resolution,
                                                  points ? _fbb.CreateVector<const vox::fbs::Vector3D *>(*points) : 0,
                                                  buckets ? _fbb.CreateVector<flatbuffers::Offset<PointHashGridSearcherBucket3>>(*buckets) : 0);
}

inline const vox::fbs::PointHashGridSearcher3 *GetPointHashGridSearcher3(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::PointHashGridSearcher3>(buf);
}

inline bool VerifyPointHashGridSearcher3Buffer(
                                               flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<vox::fbs::PointHashGridSearcher3>(nullptr);
}

inline void FinishPointHashGridSearcher3Buffer(
                                               flatbuffers::FlatBufferBuilder &fbb,
                                               flatbuffers::Offset<vox::fbs::PointHashGridSearcher3> root) {
    fbb.Finish(root);
}
