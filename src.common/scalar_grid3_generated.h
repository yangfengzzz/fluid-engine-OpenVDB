...
inline flatbuffers::Offset<ScalarGrid3> CreateScalarGrid3Direct(
    ...
    return vox::fbs::CreateScalarGrid3(
                                       _fbb,
                                       resolution,
                                       gridSpacing,
                                       origin,
...
inline const vox::fbs::ScalarGrid3 *GetScalarGrid3(const void *buf) {
    return flatbuffers::GetRoot<vox::fbs::ScalarGrid3>(buf);
}

inline bool VerifyScalarGrid3Buffer(
                                    flatbuffers::Verifier &verifier) {
    return verifier.VerifyBuffer<vox::fbs::ScalarGrid3>(nullptr);
}

inline void FinishScalarGrid3Buffer(
                                    flatbuffers::FlatBufferBuilder &fbb,
                                    flatbuffers::Offset<vox::fbs::ScalarGrid3> root) {
    fbb.Finish(root);
}
